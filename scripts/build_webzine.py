...
NOTEBOOK_TITLES = {
    ...
    "36-project-planning-vs-helena_Grok.md": "프로젝트 기획 vs 헬레나",
    "37-free-runtime-planner-whitepaper_Grok.md": "무료 런타임 플래너 백서",
    "38-s21-voice-driven-analysis.md": "S21 보이스 기반 분석",
    "38-web-designer-workpad_Grok.md": "웹디자이너 워크패드",
    "40-definitive-dev-whitepaper.md": "개발 확정 백서",
    "41-naver-blog-intro-final.md": "네이버 블로그 최종 소개",
    "42-hq-affiliate-architecture.md": "HQ 어필리에이트 아키텍처",
    "43-ui-less-architect.md": "UI 없는 설계",
    "46-first-install-case-study-meeting-prep_Boss.md": "첫 설치 사례 연구",
    "46-fridge-architecture_Claude.md": "Fridge 아키텍처",
    "46-node-protocol-architecture.md": "노드 프로토콜 구조",
    "47-human-ai-dialogue-crisis.md": "인간-AI 대화 위기",
    "48-director-video-recurrence_Grok.md": "Director 영상 반복 생성",
    "49-director-community-research_Grok.md": "Director 커뮤니티 리서치",
    "50-director-pro-v3-visual-proof_Grok.md": "Director Pro v3 시각 증명",
    "51-scout-v2-community-research_Grok.md": "Scout v2 커뮤니티 리서치",
    "52-director-vision-qa-loop_Grok.md": "Director Vision QA 루프",
    "53-director-plan-settings_Grok.md": "Director 플랜 세팅",
    "54-director-pro-v5-five-act_Grok.md": "Director Pro v5 5막",
    "55-director-pro-v6-perfect_Grok.md": "Director Pro v6 완성형",
    "56-director-perfect-ship-process_Grok.md": "Director 출하 프로세스",
    "57-director-community-a-bar_Grok.md": "Director 커뮤니티 A바",
    "58-video-three-tracks_Grok.md": "영상 3트랙 전략",
    "59-grok-video-process-whitepaper_Grok.md": "Grok 영상 프로세스 백서",
    "60-director-pro-v8-wish_Grok.md": "Director Pro v8 소망",
    "61-landing-6clip-bgm-plan_Grok.md": "랜딩 6클립 BGM 기획",
    "61-session-deepseek-cc-2026-08-02_Grok.md": "DeepSeek CC 세션 0802",
    "62-grok-plugin-video-pipe_Grok.md": "Grok 플러그인 영상 파이프",
    "63-video-plugin-standard-v1_Grok.md": "영상 플러그인 표준 v1",
    "64-process-80-squeeze_Grok.md": "프로세스 80% 압축",
    "65-video-playable-encode-fix_Grok.md": "영상 인코딩 수정",
    "66-grok-pd-voice-bridge-not-page-raster_Grok.md": "Grok PD 보이스 브릿지",
    "67-grok-subscribe-voice-bgm-hurdle_Grok.md": "Grok 구독 보이스 BGM 장벽",
    "68-imagine-prompt-standard-v1_Grok.md": "Imagine 프롬프트 표준 v1",
    "69-voice-engine-plugin-final_Grok.md": "음성 엔진 플러그인 최종",
    "69-session-resume-pd-bridge-v1_Grok.md": "세션 재개 PD 브릿지 v1",
    "70-ai-voice-core-gift-local-train_Grok.md": "AI 음성 코어 선물 로컬 훈련",
    "70-font-bgm-fix_Grok.md": "폰트 BGM 수정",
    "71-pd-intro-v2-slide-black-fix_Grok.md": "PD 인트로 v2 슬라이드 블랙 수정",
    "72-pd-pipeline-standard-v2-lock_Grok.md": "PD 파이프라인 표준 v2 잠금",
    "73-pd-grok-notebook-report_Grok.md": "PD Grok 노트북 리포트",
    ...
    "42-pc-sapjil-postmortem_Boss.md": "PC 삽질 포스트모템",
    "41-github-free-maxout_Boss.md": "GitHub 무료 한계 돌파",
    ...
    "116-phone-t-worklog-parsed_Claude.md": "Phone T 작업일지 파싱 — 폰티·컨테이너·녹화 MCP",
}
